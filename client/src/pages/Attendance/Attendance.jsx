...
const Attendance = () => {
  ...
  // Corrected state: isOpen -> calendarIsOpen
  ...
  const handleDateChange = (date) => {
    setDate(date);
    setCalendarIsOpen(false); // Close the calendar once a date is selected
  };
        ...
        <div className={isOpen ? "main-header active" : "main-header"}>
          ...
          <div className="right-box">
            <div className="d-flex align-items-center">
              ...
              <div className="calendar-icon me-3">
                <FaCalendarAlt
                  className="calendar-icon"
                  onClick={() => setCalendarIsOpen(!calendarIsOpen)} // Toggle calendar visibility
                />
              </div>

              {/* Date Picker hidden inside */}
              {calendarIsOpen && (
